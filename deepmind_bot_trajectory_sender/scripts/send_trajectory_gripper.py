...
def main(args=None):
    ...
    action_client = ActionClient(node, FollowJointTrajectory, '/deepmind_bot_gripper_controller/follow_joint_trajectory')
    ...
    goal_msg.trajectory.joint_names = [ 'deepmind_robot1_gripper1_joint',
